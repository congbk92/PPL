...
class MCVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MCParser#val_type.
    def visitVal_type(self, ctx:MCParser.Val_typeContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MCParser#val_declare.
    def visitVal_declare(self, ctx:MCParser.Val_declareContext):
        return self.visitChildren(ctx)
